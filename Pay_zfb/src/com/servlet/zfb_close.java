  ...
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      result = ((AlipayTradeCloseResponse)alipayClient.execute(alipayRequest)).getBody();
    }
    catch (Exception e)
    {
      e.printStackTrace();
    ...
    JSONObject jsonObject2 = JSON.parseObject(jsonObject.getString("alipay_trade_close_response"));
